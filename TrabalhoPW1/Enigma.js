...
var maqEnigma = {
	...
	R1 : encontraCheck(document.getElementsByName('nR1')),
	R2 : encontraCheck(document.getElementsByName('nR2')),
	R3 : encontraCheck(document.getElementsByName('nR3')),
...
function blockCheck3(){
 ...
 R1 : document.getElementsByName('nR1'),
 R2 : document.getElementsByName('nR2'),
 R3 : document.getElementsByName('nR3'),



blockCheck3 : function(){

	
	for(let i = 0; i < R2.length; i++){
		if( (this.R3[i].checked || this.R1[i].checked) && !this.R2[i].checked){
			this.R2[i].disabled = true;
			document.getElementsByClassName("lR2")[i].style.color = "gray";
		}
		else{
			this.R2[i].disabled = false;
			document.getElementsByClassName("lR2")[i].style.color = "black";
		}
	}

	for(let i = 0; i < R1.length; i++){
		if( (this.R3[i].checked || this.R2[i].checked) && !this.R1[i].checked){
			this.R1[i].disabled = true;
			document.getElementsByClassName("lR1")[i].style.color = "gray";
		}
		else{
			this.R1[i].disabled = false;
			document.getElementsByClassName("lR1")[i].style.color = "black";
		}
	}
}
...
function blockCheck2(){
	...
	for(let i = 0; i < R1.length; i++){
		if( (R3[i].checked || R2[i].checked) && !R1[i].checked){
			R1[i].disabled = true;
			document.getElementsByClassName("lR1")[i].style.color = "gray";
		}
		else{
...
function blockCheck1(){
	...
	for(let i = 0; i < R2.length; i++){
		if( (R3[i].checked || R1[i].checked) && !R2[i].checked){
			R2[i].disabled = true;
			document.getElementsByClassName("lR2")[i].style.color = "gray";
		}
		else{
...
//Verifica se a letra precisa ser criptografada
